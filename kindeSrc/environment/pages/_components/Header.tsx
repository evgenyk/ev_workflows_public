...
export const Header = () => {
  return (
    <header
      className="gn__navigation-module__headerSimple-kAJqr"
      data-binding="global-navigation"
      data-env="prod"
      data-base-url=""
    >
      <nav
        className="gn__navigation-module__headerNav-AxSlv"
        aria-label="main navigation"
      >
        <a
          className="gn__skipLink-module__skipLink-dGBEq"
          href="#main-content"
          data-binding="skip-link"
        >
          Skip to main content
        </a>
        <div className="gn__navigation-module__headerInner-sFiAT">
          <div className="gn__navigation-module__headerTop--aU1K">
            <a
              href="/"
              className="gn__navigation-module__headerLogo-0EooL"
              aria-label="Which homepage"
            >
              <svg
