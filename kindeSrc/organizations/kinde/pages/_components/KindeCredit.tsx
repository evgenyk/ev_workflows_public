...
export const KindeCredit = () => {
  const { translations } = useKinde();
  return (
    <aside className="l-auth-layout__credit">
      <p className="l-auth-layout__credit-label   kui-util-type-body-caption">
        {translations.poweredBy}{" "}
        <span className="kui-util-hide-visually">Kinde</span>
      </p>
      <a
        aria-label="Visit Kinde"
        className="l-auth-layout__credit-link"
      ...
      >
        <svg
          ...
          className="kui-kinde-logo kui-kinde-logo--has-customisable-color"
          role="img"
          viewBox="0 0 86 28"
          width="73"
        ...
        >
          {" "}
          <title id="kui_kinde_logo_title">Kinde</title>{" "}
          <path
            fill-rule="evenodd"
